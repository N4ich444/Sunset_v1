...
CMD flock -w 60 shareddata/Data/ -c "rsync -av  --delete --filter='protect worlds/*/' --filter='protect modules/*/' --filter='protect systems/*/' --filter='protect assets/*/' userdata/Data/ shareddata/Data/" ; rm userdata/Config/admin.txt
